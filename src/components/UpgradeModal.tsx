...
export function UpgradeModal({ open, onOpenChange }: UpgradeModalProps) {
  ...
  const prepareMonimePayload = (reference: string) => ({
    ...
    success_url: `${window.location.origin}/payment-success?subscription=monime_success&ref=${reference}`,
    cancel_url: `${window.location.origin}/payment-failure?subscription=monime_cancel&ref=${reference}`,
  });
