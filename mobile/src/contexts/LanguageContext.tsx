...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "dashboard.birthdaysNext7Days": "Birthdays in the next 7 days",
    ...
    "dashboard.noRecentTransactions": "No recent transactions found",
    "dashboard.noBirthdays": "No upcoming birthdays in the next 7 days",
